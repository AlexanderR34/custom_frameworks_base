...
public class GlobalSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Global.LOCK_SOUND, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Global.UNLOCK_SOUND, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Global.CHARGING_STARTED_SOUND, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Global.WIRELESS_CHARGING_STARTED_SOUND, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Global.LOW_BATTERY_SOUND, ANY_STRING_VALIDATOR);
        VALIDATORS.put(
