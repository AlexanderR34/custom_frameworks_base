...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.SPOOF_PIF_CONFIG, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.SPOOF_PIF_PHOTOS, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.SPOOF_GAMEPROPS_CONFIG, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.SPOOF_TRICKYSTORE_TARGET, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.SPOOF_TRICKYSTORE_KEYBOX, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.SPOOF_TRICKYSTORE_PATCH, ANY_STRING_VALIDATOR);
