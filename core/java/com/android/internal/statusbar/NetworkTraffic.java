...
public class NetworkTraffic extends TextView {
            ...
            private void displayStatsAndReschedule() {
                ...
                if (!enabled || shouldHide) {
                    ...
                    if (showUpstream && showDownstream) {
                        output.append(formatOutput(mTxKbps + mRxKbps));
    ...
    private final CustomStatusBarItem.DarkReceiver mDarkReceiver =
    ...
    private final CustomStatusBarItem.VisibilityReceiver mVisibilityReceiver =
    ...
    protected void onAttachedToWindow() {
        ...
        CustomStatusBarItem.Manager manager = CustomStatusBarItem.findManager((View) this);
